...
import com.dintal.interview.service.AIEService;
import com.dintal.interview.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.dintal.interview.domain.AIE}.
 */
@RestController
...
public class AIEResource {
    ...
    private static final String ENTITY_NAME = "interviewAie";
